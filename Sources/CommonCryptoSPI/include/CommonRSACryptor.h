 ...
 */
CCRSACryptorRef
CCRSACryptorCreatePublicKeyFromPrivateKey(CCRSACryptorRef privkey)
 ...
 */
CCRSACryptorRef
CCRSACryptorGetPublicKeyFromPrivateKey(CCRSACryptorRef privkey)
...
*/
CCCryptorStatus
CCRSACryptorImport(const void *keyPackage, size_t keyPackageLen, CCRSACryptorRef *key)
API_AVAILABLE(macos(10.7), ios(5.0));
 ...
 */
CCCryptorStatus
CCRSACryptorExport(CCRSACryptorRef key, void *out, size_t *outLen)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCRSAKeyType
CCRSAGetKeyType(CCRSACryptorRef key)
API_AVAILABLE(macos(10.7), ios(5.0));
...
CCCryptorStatus
CCRSACryptorSign(CCRSACryptorRef privateKey, CCAsymmetricPadding padding, const void *hashToSign, size_t hashSignLen, CCDigestAlgorithm digestType, size_t saltLen, void *signedData, size_t *signedDataLen)
API_AVAILABLE(macos(10.7), ios(5.0));
...
CCCryptorStatus
CCRSACryptorVerify(CCRSACryptorRef publicKey, CCAsymmetricPadding padding, const void *hash, size_t hashLen, CCDigestAlgorithm digestType, size_t saltLen, const void *signedData, size_t signedDataLen)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCCryptorStatus
CCRSACryptorDecrypt(CCRSACryptorRef privateKey, CCAsymmetricPadding padding, const void *cipherText, size_t cipherTextLen, void *plainText, size_t *plainTextLen, const void *tagData, size_t tagDataLen, CCDigestAlgorithm digestType)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCCryptorStatus
CCRSAGetKeyComponents(CCRSACryptorRef rsaKey, uint8_t *modulus, size_t *modulusLength, uint8_t *exponent, size_t *exponentLength, uint8_t *p, size_t *pLength, uint8_t *q, size_t *qLength)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCCryptorStatus
CCRSACryptorCreateFromData(CCRSAKeyType keyType, const uint8_t *modulus, size_t modulusLength, const uint8_t *publicExponent, size_t publicExponentLength, const uint8_t *p, size_t pLength, const uint8_t *q, size_t qLength, CCRSACryptorRef *ref)
API_AVAILABLE(macos(10.7), ios(5.0));
