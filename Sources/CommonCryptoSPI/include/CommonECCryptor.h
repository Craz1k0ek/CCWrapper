...
*/
CCCryptorStatus
CCECCryptorGeneratePair(size_t keysize, CCECCryptorRef *publicKey, CCECCryptorRef *privateKey)
...
*/
CCCryptorStatus
CCECCryptorImportPublicKey(const void *keyPackage, size_t keyPackageLen, CCECCryptorRef *key)
API_AVAILABLE(macos(10.7), ios(5.0));
 ...
 */
CCCryptorStatus
CCECCryptorImportKey(CCECKeyExternalFormat format, const void *keyPackage, size_t keyPackageLen, CCECKeyType keyType, CCECCryptorRef *key)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCCryptorStatus
CCECCryptorSignHash(CCECCryptorRef privateKey, const void *hashToSign, size_t hashSignLen, void *signedData, size_t *signedDataLen)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCCryptorStatus
CCECCryptorVerifyHash(CCECCryptorRef publicKey, const void *hash, size_t hashLen, const void *signedData, size_t signedDataLen, uint32_t *valid)
API_AVAILABLE(macos(10.7), ios(5.0));
...
*/
CCCryptorStatus
CCECCryptorTwinDiversifyKey(CCECKeyType keyType, CCECCryptorRef inKey, void *entropy, size_t entropyLen, CCECCryptorRef *outKey)
 ...
 */
CCCryptorStatus
CCECCryptorGetKeyComponents(CCECCryptorRef ecKey, size_t *keySize, uint8_t *qX, size_t *qXLength, uint8_t *qY, size_t *qYLength, uint8_t *d, size_t *dLength)
API_AVAILABLE(macos(10.7), ios(5.0));
